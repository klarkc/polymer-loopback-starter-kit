...
// Copy all files at the root level (client)
...
gulp.task('html', function() {
  return optimizeHtmlTask(
    ['client/**/*.html', '!client/{elements,test,bower_components}/**/*.html'],
    dist());
});
...
gulp.task('clean', function() {
  return del(['.tmp', 'client/scripts/bundle.js', dist()]);
});

// Watch files for changes & reload
gulp.task('serve:client', ['lbclient', 'styles'], function() {
  browserSync({
    port: 5000,
    notify: false,
    logPrefix: 'PSK',
  ...
  gulp.watch(['client/**/*.html', '!client/bower_components/**/*.html'], reload);
  gulp.watch(['client/styles/**/*.css'], ['styles', reload]);
  gulp.watch(['client/scripts/**/*.js'], reload);
  gulp.watch(['client/loopback/**/*.js'], ['lbclient', reload]);
